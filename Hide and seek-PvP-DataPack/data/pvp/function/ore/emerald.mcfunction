...
execute as @a at @s if score @s PvP_Item_ore matches 1..100 run execute as @s positioned ^ ^3 ^-3.5 facing entity @s feet run setblock ~ ~-2 ~ minecraft:emerald_ore replace
