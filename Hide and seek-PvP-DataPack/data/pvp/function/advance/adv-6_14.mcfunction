...
execute as @a[scores={pvp_advance=1..2}] at @s unless entity @s[scores={PvP_40=1}] if entity @s[y=40,dy=31] run function pvp:40/fast
execute as @a[scores={pvp_advance=1..2}] at @s if entity @s[scores={PvP_40=1}] unless entity @s[y=40,dy=31] run function pvp:40/second
