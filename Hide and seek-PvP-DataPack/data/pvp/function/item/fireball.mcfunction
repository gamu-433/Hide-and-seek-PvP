...
execute as @s at @s run summon minecraft:fireball ^ ^1.4 ^1 {Tags:["fireball"],PortalCooldown:2,ExplosionPower:2}
...
# execute as @e[type=minecraft:fireball] run data modify entity @s ExplosionPower set value 2