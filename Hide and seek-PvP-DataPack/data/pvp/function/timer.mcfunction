...
execute if score 状況 pvp_advance matches 6..9 if score タイマー pvp_advance matches 60 run execute as @a at @s run function pvp:announce/sadon
execute if score 状況 pvp_advance matches 6..9 if score タイマー pvp_advance matches 0 run execute as @a at @s run function pvp:sadon
execute if score 状況 pvp_advance matches 6..9 if score タイマー pvp_advance matches 4..10 run execute as @a at @s run playsound minecraft:ui.button.click master @s ~ ~ ~ 1 1
execute if score 状況 pvp_advance matches 6..9 if score タイマー pvp_advance matches 1..3 run execute as @a at @s run playsound minecraft:ui.button.click master @s ~ ~ ~ 1 2
