...
execute if score 鉱石抽選 pvp_kouseki_k1 matches 0 run execute store result storage minecraft:ore_random index int 1 run scoreboard players get 赤 pvp_advance
execute if score 鉱石抽選 pvp_kouseki_k1 matches 0 run data modify storage minecraft:ore_random random0 set from storage minecraft:ore_random index
...
execute if score 鉱石抽選 pvp_kouseki_k1 matches 1 run execute unless predicate pvp:draft run execute store result storage minecraft:ore_random index int 1 run scoreboard players get 青 pvp_advance
execute if score 鉱石抽選 pvp_kouseki_k1 matches 1 run execute unless predicate pvp:draft run data modify storage minecraft:ore_random random1 set from storage minecraft:ore_random index
...
execute if score 鉱石抽選 pvp_kouseki_k1 matches 2 run execute unless predicate pvp:draft run execute store result storage minecraft:ore_random index int 1 run scoreboard players get 緑 pvp_advance
execute if score 鉱石抽選 pvp_kouseki_k1 matches 2 run execute unless predicate pvp:draft run data modify storage minecraft:ore_random random2 set from storage minecraft:ore_random index
...
execute if score 鉱石抽選 pvp_kouseki_k1 matches 3 run execute unless predicate pvp:draft run execute store result storage minecraft:ore_random index int 1 run scoreboard players get 黄 pvp_advance
execute if score 鉱石抽選 pvp_kouseki_k1 matches 3 run execute unless predicate pvp:draft run data modify storage minecraft:ore_random random3 set from storage minecraft:ore_random index
...
execute if score 鉱石抽選 pvp_kouseki_k1 matches 4 run execute unless predicate pvp:draft run execute store result storage minecraft:ore_random index int 1 run scoreboard players get 水色 pvp_advance
execute if score 鉱石抽選 pvp_kouseki_k1 matches 4 run execute unless predicate pvp:draft run data modify storage minecraft:ore_random random4 set from storage minecraft:ore_random index
...
execute if score 鉱石抽選 pvp_kouseki_k1 matches 5 run execute unless predicate pvp:draft run execute store result storage minecraft:ore_random index int 1 run scoreboard players get 紫 pvp_advance
execute if score 鉱石抽選 pvp_kouseki_k1 matches 5 run execute unless predicate pvp:draft run data modify storage minecraft:ore_random random5 set from storage minecraft:ore_random index
...
execute if score 鉱石抽選 pvp_kouseki_k1 matches 6 run execute unless predicate pvp:draft run execute store result storage minecraft:ore_random index int 1 run scoreboard players get オレンジ pvp_advance
execute if score 鉱石抽選 pvp_kouseki_k1 matches 6 run execute unless predicate pvp:draft run data modify storage minecraft:ore_random random6 set from storage minecraft:ore_random index
...
execute if score 鉱石抽選 pvp_kouseki_k1 matches 6 run function pvp:team/ore_random3